        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @endif
                    <form action="{{ route('category-post') }}" method="POST" class="w-1/2 mx-auto bg-white rounded-xl border-gray-100">
                        @csrf
                        <div class="px-4 py-2 bg-white border-gray-100">
                            <input
                                class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                name="name" id="name" value="{{ old('name') }}" placeholder="Enter category name">
                        </div>
                        <div class="px-4 py-2 ">
